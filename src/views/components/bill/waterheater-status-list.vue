<template>
    <div class="waterheater-status-list">
        ...
        return {
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        return (
                            <span>{ this.clean(params.row.CleanControl) }</span>
                        )
                    },
                    width: 100
                },
    ...
    methods: {
        ...
        exportData () {
            ...
            temp.forEach(element => {
                ...
                element.CleanControl = this.clean(element.CleanControl)
